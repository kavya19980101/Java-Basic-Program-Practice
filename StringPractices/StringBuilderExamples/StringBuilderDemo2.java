...
public class StringBuilderDemo2 {
    public static void main(String args[])
    {
        ...
        System.out.println(str1.append("Shekar"));//Appends the specified character or object to the end of the string.
        ...
        System.out.println(str1.capacity());//Returns the current capacity of the string builder.
